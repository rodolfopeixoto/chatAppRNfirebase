...
class MessageFormComponent extends Component{
  constructor(){
    super();
    this.handlerMessageChange = (message) => {
      this.props.updateMessage(message);
    }

    this.handlerButtonPress = () => {
    ...
    return(
      <View style={styles.container} >
        <TextInput 
          ...
          returnKeyType='send'
          onChangeText={this.handlerMessageChange}
       ...
       <TouchableOpacity>
         <Image source={require('../../../../images/ic_send.png') } styles={{opacity: opacity}} />
       </TouchableOpacity>
